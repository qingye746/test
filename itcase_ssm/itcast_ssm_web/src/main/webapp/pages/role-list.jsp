									...
									<c:forEach items="${roleList}" var="role">
										<tr>
											...
											<td class="text-center">
												<a href="${pageContext.request.contextPath}/role/findRollAndOtherAllPermission.do?id=${role.id}" class="btn bg-olive btn-xs">添加权限</a>
												<a href="${pageContext.request.contextPath}/role/findById.do?id=${role.id}" class="btn bg-olive btn-xs">详情</a>
												<a href="${pageContext.request.contextPath}/role/findRollAndAllPermission.do?id=${role.id}" class="btn bg-olive btn-xs">删除权限</a>
												<a href="${pageContext.request.contextPath}/role/delRoleById.do?id=${role.id}" class="btn bg-olive btn-xs">删除角色</a>
											</td>
										</tr>
									</c:forEach>
								</tbody>
